...
public static class LocalizationText
{
    private static readonly Dictionary<string, string> translations = new Dictionary<string, string>
    {
        ...
        { "Keep playing to reveal this achievement.", "继续游玩以揭示这个成就。" },
        { "First Blood", "初战告捷" },
        { "Defeat your first enemy.", "击败第一个敌人。" },
        { "Monster Hunter", "怪物猎人" },
        { "Defeat 10 enemies.", "累计击败 10 个敌人。" },
        { "DeathBringer Down", "死神陨落" },
        { "Defeat the DeathBringer.", "击败 DeathBringer。" },
        { "Soul Collector", "灵魂收藏家" },
        { "Collect 1000 souls.", "累计获得 1000 个灵魂。" },
        { "Safe Place", "安全之地" },
        { "Activate your first checkpoint.", "激活第一个检查点。" },
        { "Skill Awakened", "技能觉醒" },
        { "Unlock your first skill.", "解锁第一个技能。" },
        { "Well Equipped", "整装待发" },
        { "Equip your first item.", "装备第一件物品。" },
        { "First Craft", "初次制作" },
        { "Craft your first item.", "制作第一件物品。" },
        { "Not Today", "今天不行" },
        { "Use a flask for the first time.", "第一次使用药瓶。" },
